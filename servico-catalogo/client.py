...
now = datetime.now()
file_name = f"catalogo_{now.strftime('%Y-%m-%d_%H-%M')}.csv"
...
print(f"Iniciando serviço de Catálogo. Métricas serão salvas em {file_name}")
...
while True:
    ...
    try:
        ...
        print(f"!!! Erro no serviço de catalogo: {e}")
